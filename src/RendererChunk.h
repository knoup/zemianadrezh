	...
	public:
		...
		void update(const WorldChunk* _chunk) {
			...
			for(auto& block : blocks) {
				...
				sf::Vector2f textureTopLeft 	{textureRect.left,
												textureRect.top};

				sf::Vector2f textureTopRight 	{textureRect.left + textureRect.width,
												textureRect.top};

				sf::Vector2f textureBottomRight {textureRect.left + textureRect.width,
												textureRect.top + textureRect.height};

				sf::Vector2f textureBottomLeft 	{textureRect.left,
												textureRect.top + textureRect.height};
				//-----------------------------------------------------
